...
-- Temps de generació: 15-02-2016 a les 20:07:40
...
--
ALTER TABLE `NameCA`
  MODIFY `nameid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=752;
--
...
--
ALTER TABLE `R_S_HistoricPictograms`
  MODIFY `ID_RSHPSentencePicto` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `R_S_TempPictograms`
  MODIFY `ID_RSTPSentencePicto` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `S_Historic`
  MODIFY `ID_SHistoric` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
