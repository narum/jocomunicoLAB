...
function searchPicto(base_url,selected){
    alert(selected + "\n" + base_url);
    var val = selected.value;
    var url = base_url+"PictogramSearch";
    new Ajax.Updater ('contenidor-frase', url, {method: 'post', postBody: data, evalScripts: true});
    var url = base_url+"PictogramSearch/searchPicto";
    
    new Ajax.Request (url, {method: 'post', postBody: val, evalScripts: true});
}
